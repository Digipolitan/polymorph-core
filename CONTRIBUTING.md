# Contributing to polymorph-core
...
* **Did the problem start happening recently** (e.g. after updating to a new version of polymorph-core) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of polymorph-core ?** What's the most recent version in which the problem doesn't happen? You can download older versions of polymorph-core from [the releases page](https://github.com/digipolitan/polymorph-core/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of polymorph-core are you using?
...
#### Template For Submitting Bug Reports
    ...
    **polymorph-core version:** [Enter polymorph-core version here]
    ...
    * Problem started happening recently, didn't happen in an older version of polymorph-core: [Yes/No]
