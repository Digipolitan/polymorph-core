# Contributing to polymorph-core-swift
...
* **Did the problem start happening recently** (e.g. after updating to a new version of polymorph-core-swift) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of polymorph-core-swift ?** What's the most recent version in which the problem doesn't happen? You can download older versions of polymorph-core-swift from [the releases page](https://github.com/digipolitan/polymorph-core-swift/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of polymorph-core-swift are you using?
...
#### Template For Submitting Bug Reports
    ...
    **polymorph-core-swift version:** [Enter polymorph-core-swift version here]
    ...
    * Problem started happening recently, didn't happen in an older version of polymorph-core-swift: [Yes/No]
