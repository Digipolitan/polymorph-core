# Contributing to polymorpth-core-swift
...
* **Did the problem start happening recently** (e.g. after updating to a new version of polymorpth-core-swift) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of polymorpth-core-swift ?** What's the most recent version in which the problem doesn't happen? You can download older versions of polymorpth-core-swift from [the releases page](https://github.com/digipolitan/polymorpth-core-swift/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of polymorpth-core-swift are you using?
...
#### Template For Submitting Bug Reports
    ...
    **polymorpth-core-swift version:** [Enter polymorpth-core-swift version here]
    ...
    * Problem started happening recently, didn't happen in an older version of polymorpth-core-swift: [Yes/No]
